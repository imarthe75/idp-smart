...
if __name__ == "__main__":
    # Escuchamos en 127.0.0.1:18001. Nginx en el puerto 8000 actuará como proxy externo.
    # Esto evita conflictos con puertos bajos y es consistente con vLLM en 18000.
